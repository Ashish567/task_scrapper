...
let app = express();
var s3 = new aws.S3({
	accessKeyId: 'AKIAJGV5XNO6WWMKYWMQ',
	secretAccessKey: '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' 
});
								...
								jimp.read(src, function (err, image) {
									if(err)  console.log("Code 3: Jimp read Error");
										...
										image.greyscale().getBase64(jimp.AUTO,function(err, imageData) {
											...
											params = {Bucket: 'photos1345', Key: '/' + documentId+'/'+fileName.toString()+'.jpg', Body: new Buffer(imageData, 'base64'),ACL:'public-read'};
